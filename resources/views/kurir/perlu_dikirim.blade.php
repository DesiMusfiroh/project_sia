...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <h3 class="text-center"> <b> Pesanan yang perlu dikirim </b></h3> <hr>
        <div class="progress">
            <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <br>
        <div class="row">
        @foreach ($perlu_dikirim as $item) 
                ...
                <div class="card ">
                    ...
                    <div class="card-body pb-3 "  >
                        ...
                        <div class="text-right">
                            <form action="/kurir/pengiriman/update_kirim" method="post">                         
                                @csrf
                                @method('PATCH')
                                ...
                                <button type="submit" style="background-color:#c4eb2a; " class="btn btn-sm text-center " >  
                                    <i class="fa fa-truck"></i> <b> Lakukan Pengiriman  </b>   
                                </button>
                            </form>
                        </div>
                    </div>
