                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('kasir.transaksi', $pesan->id) }}" style="background-color:#c4eb2a; " class="btn btn-sm" > <span class="fa fa-search"></span></a>
                                <a href="{{ route('customer.order_pdf', $pesan->id) }}" target="_blank"> <span class="fa fa-print"></span> </a>  
                            </td>
                            <!-- <form method="GET" >                      
                                <input type="hidden" id="pesanan_id" name="pesanan_id" value="{{ $pesan->id }}">
                                <button type="submit" id="kirim" name="kirim" style="background-color:#c4eb2a; " class="btn btn-sm" data-toggle="modal" data-target=".detail_modal" 
                                    data-id = "{{ $pesan->id }}"
                ...
                <div class="container">         
                    ...
                    <div class="form-group mt-2"> <!-- Baris Tabel Produk yang  dipesan -->
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php $detail = App\Detail_pesanan::where('pesanan_id', $pesanan_id )->get(); ?>
...
$(document).ready(function(){
 ...
 // var id_pesan   = $(this).data('id');
        ...
        // });
        //$("#submit_id").hide();
        //$.post('transaksi.blade.php',(postid:id));
