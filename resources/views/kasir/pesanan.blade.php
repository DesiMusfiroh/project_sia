        ...
        <section class="content">
            ...
            <div class="row">                           
                    ...
                    <form action="/kasir/detail_pesanan/store" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="produk_id" id="produk_id" class="form-control" required width="100%">
                                ...
                                <option value="{{ $pro->id }}" id_produk="{{$pro->id}}">{{ $pro->kode }} - {{ $pro->nama }} ( {{ $pro->stok }} )</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">Jumlah</label>
                            <input type="number" name="jumlah" id="jumlah" value="1" min="1"  max="{{$pro->stok}}" class="form-control">
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-9"> <!-- Sisi Kanan Proses Pemesanan-->   
                    <form action="/kasir/pesanan/store" enctype="multipart/form-data" method="post">
                    @csrf

                    <div class="row">  <!-- Baris Pelanggan -->
                        <div class="col-md-8">
                    ...
                    <div class="row mb-2"> <!-- Baris Pelanggan -->
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <select name="pelanggan_id" id="pelanggan_id" class="form-control" required width="100%">
                                        ...
                                        <option value="{{ $pel->id }}" 
                                            id_customer="{{ $pel->id }}" 
                                            nama_customer="{{$pel->nama}}" 
                                            no_hp_customer="{{$pel->no_hp}}" 
                                            email_customer="{{$pel->email}}" > 
                                                {{ $pel->nama }} 
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-2">  <!-- Tambah Pelanggan -->
                        ...
                        <div class="col-md-6"> <!-- Tampilkan Pelanggan yang dipilih -->
                            ...
                            <p style="margin-bottom:1px;"> Email :  <span id="email_customer"></span>  </p>
                        </div>
                    </div>
...
<!-- Update  modal (jumlah produk dipesan)-->
...
$(document).ready(function(){
    ...
    //     var produk_id = $('produk_id option:selected').attr("id_produk");
    //     $("#jumlah_produk").val(jumlah_produk);
    // });
    
    //$("#jumlah_produk").chained("#produk_id");
/*
    $('#pelanggan_id').change(function(){
        var nama = $('#pelanggan_id option:selected').text();
