    ...
    <div id="app">
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs justify-content-center nav-fill ">
                ...
                <li class="nav-item ">
                    <a class="nav-link {{(request()->is('gudang/produk')) ? 'active' : ''}}" style="font-weight:bold;" href="/gudang/produk">Produk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{(request()->is('gudang/produk/stok')) ? 'active' : ''}}" style="font-weight:bold;" href="/gudang/produk/stok">Stok</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{(request()->is('gudang/preorder')) ? 'active' : ''}}"  style="font-weight:bold;" href="#">Preorder</a>
                </li>
